...
if($dopost=='upload')
{
	...
	for($i=1; $i <= $totalform; $i++)
	{
	 ...
	 if($cfg_remote_site=='Y' && $remoteuploads == 1)
	 {
	 	  ...
	 	  $imgHtml .=  "<a href=\"javascript:dPlayNext();\"><img src=\"$imgsrcValue\" width=\"$imgwidthValue\" border=\"0\" height=\"$imgheightValue\" alt=\"$altname\" title=\"$altname\" style=\"cursor:pointer\" /></a><br />\r\n";
	 } else {
			if($cfg_multi_site=='N')
			{
				$imgHtml .=  "<a href=\"javascript:dPlayNext();\"><img src=\"$imgsrcValue\" width=\"$imgwidthValue\" border=\"0\" height=\"$imgheightValue\" alt=\"$altname\" title=\"$altname\" style=\"cursor:pointer\" /></a><br />\r\n";
