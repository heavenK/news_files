...
/*
		var start_p = serverData.indexOf("FILEID:");
		if (start_p && serverData.substring(start_p, start_p+7) === "FILEID:") {
			addImage("swfupload.php?dopost=thumbnail&id=" + serverData.substring(start_p+7), serverData.substring(start_p+7));
