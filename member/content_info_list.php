...
$whereSql .= " And inp.username='$uname' ";

$query = "select arc.aid,arc.aid as id,arc.typeid,arc.senddate,arc.channel,arc.click,arc.title,arc.mid,tp.typename,inp.username,inp.nickname,arc.arcrank
        from `#@__infop` inp
		left join `{$cInfos['addtable']}` arc on inp.aid=arc.aid
...
$dlist->SetTemplate(DEDEMEMBER."/templets/content_info_list.htm");
