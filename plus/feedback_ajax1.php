 ...
 * @license        http://help.dedecgerms.com/usersguide/license.html
...
?>
	<div class='decmt-box2'style="width:645px; margin-left:31px; display:inline; overflow:hidden; float:left;"> <ul>
     <li style="width:645px; border-bottom:1px dashed #b4b4b4; overflow:hidden; float:left;">
		<p style="width:645px; margin-top:19px; line-height:22px; font-size:14px; color:666666; overflow:hidden; float:left;"><?php echo $msg; ?></p>
      <span class="title" style="width:500px; height:14px; margin:6px 0 21px 0; display:inline; color:#999999; overflow:hidden; float:left;">--<?php echo $username; ?> <?php echo GetDateMk($dtime); ?></span>
      <div class="comment_act"><span class="fr">
<span id='badfb<?php echo $id; ?>'>
				<a href='#badfb<?php echo $id; ?>' onclick="postBadGood('badfb',<?php echo $id; ?>);"style=" width:30px; height:14px; overflow:hidden; float:right; margin:6px 0 21px 10px; display:inline; color:#333333;">回帖</a>
			</span>
            <span id='goodfb<?php echo $id; ?>'>
				<a href='#goodfb<?php echo $id; ?>' onclick="postBadGood('goodfb',<?php echo $id; ?>);" style=" width:30px; height:14px; overflow:hidden; float:right; margin:6px 0 21px 10px; display:inline; color:#333333;">顶</a>
			</span>
			<span class='quote'>
...
?>
<div class="decmt-box2"  style="width:645px; margin-left:31px; display:inline; overflow:hidden; float:left;">
   <ul>
     <li style="width:645px; border-bottom:1px dashed #b4b4b4; overflow:hidden; float:left;">
      <p style="width:645px; margin-top:19px; line-height:22px; font-size:14px; color:666666; overflow:hidden; float:left;"><?php echo $msg; ?></p>
      <span class="title" style="width:500px; height:14px; margin:6px 0 21px 0; display:inline; color:#999999; overflow:hidden; float:left;">--<?php echo $username; ?> <?php echo GetDateMk($dtime); ?></span>
      <div class="comment_act"><span class="fr">
			...
			<span class='quote'>
				<?php /*?><a href='/plus/feedback.php?aid=<?php echo $id; ?>&fid=<?php echo $id; ?>&action=quote'">[引用]</a><?php */?>
			</span></span></div>			
