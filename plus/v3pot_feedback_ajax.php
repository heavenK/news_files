...
?>
	<div class='decmt-box2' style=" width:962px; float:left; overflow:hidden; margin-left:15px; display:inline;"> 
    <ul  style=" margin-top:17px; display:inline; float:left;">
     <li>
      <a href='<?php echo $spaceurl; ?>' class='plpic'><img src='<?php echo $mface;?>'  height='50' width='50' style=" float:left;"/></a>
      <span class="title" style=" height:24px; float:left; overflow:hidden; margin-left:13px; display:inline; font-size:14px;"><a href="<?php echo $spaceurl; ?>" style=" color:#ff86e5;"><?php echo $username; ?></a></span>
      <p style=" width:898px; float:left; overflow:hidden; margin-left:13px; display:inline; color:#ceb5d3; font-size:14px;"><?php echo $msg; ?></p>
      <div class="comment_act" style=" width:962px; height:22px; float:right; overflow:hidden;  border-bottom:1px #8b7a8f dashed; margin-top:11px; display:inline;">
      			<span style=" float:right; font-size:12px; color:#535353;"><?php echo GetDateMk($dtime); ?>发表</span>
      </div>			
...
function GetPageList($pagesize, $totalcount)
{
    ...
    echo "<div id='commetpages' style=' width:962px; float:left;  height:63px; '>";
